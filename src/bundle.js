...
var _inlineStyles = __webpack_require__(1);

var _siteConstants = __webpack_require__(2);
...
$(function () {
 ...
 4. Create Popup - createPopup / create_item_template (getPopupDetails (switch)) / createItemHtml
	...
	function initNewsPageHover() {
		...
		var sitePromises = siteSearches(_siteConstants.spectrumSites[domain], slug);
		Promise.all(sitePromises).then(function (search_results) {
...
var banana = 'CRQkZe76Sgs3SBySazIA',
    chipmunk = 'A7LZZG82AFeyBt8FW8';

var searcher = exports.searcher = '&key=' + banana.split('').reverse().join().replace(/,/g, '') + '_' + chipmunk;
